...
export default function Pagmend() {
  return (
    <form class="ui form">
  <h4 class="ui dividing header">Ödeme</h4>
  <div class="field">
    <label>İsim</label>
  ...
  <div class="two fields">
    ...
    <div class="field">
      ...
      <div class="ui fluid search selection dropdown">
        <input type="hidden" name="ülke"/>
        <i class="dropdown icon"></i>
        <div class="default text">Ülke Seçin</div>
        <div class="menu">
  ...
  <h4 class="ui dividing header">Fatura</h4>
  <div class="field">
  ...
  <div class="fields">
    <div class="seven wide field">
      ...
      <input type="text" name="Kart[numaraso]" maxlength="16" placeholder="Kart #"/>
    </div>
    <div class="three wide field">
      <label>CVC</label>
      <input type="text" name="kart[cvc]" maxlength="3" placeholder="CVC"/>
    </div>
    <div class="six wide field">
      <label>Expiration</label>
      <div class="two fields">
        <div class="field">
          <select class="ui fluid search dropdown" name="kart[expire-month]">
